...
function CoinManager({coin}: {
	coin: PrismaType<'coin'> | PrismaType<'customToken'>
}) {
	const isC = isCoin(coin);
	const table = isC ? "coin" : "customToken";
...
function isCoin(o: any): o is PrismaType<'coin'> {
	return o && typeof o === 'object' && 'subs' in o;
}
